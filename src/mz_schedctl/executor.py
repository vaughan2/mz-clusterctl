...
class Executor:
    ...
    def execute_actions(self, cluster_id: UUID, actions: List[Action]) -> Dict[str, Any]:
        """
        ...
        if summary['failed'] > 0:
            print(f"Execution completed with errors: {summary['executed']}/{summary['total']} actions succeeded")
            print("Errors:")
